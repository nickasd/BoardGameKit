...
class CrazyEightsTableNode: SCNNode {
    ...
    override init() {
        ...
        cardDeck = CardNodeDeck(cardFormat: .standardPortrait, front: { PreparedResources.material(named: "Art.scnassets/\($0).heic") }, back: { PreparedResources.material(named: "Art.scnassets/back.heic") })
